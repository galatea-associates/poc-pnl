...
public class ValuationInput {
    ...
    @CollectionTable(name="numeric_input_data", joinColumns=@JoinColumn(name="valuation_input_id"))
	...
	public Object get(String inputName) {
		return this.numericInputData.containsKey(inputName) ? this.numericInputData.get(inputName) : this.textInputData.get(inputName);
	}
	
	public boolean contains(String inputName) {
		return this.numericInputData.containsKey(inputName) || this.textInputData.containsKey(inputName);
	}
